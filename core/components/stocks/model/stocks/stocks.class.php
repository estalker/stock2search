...
class Stocks {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $basePath = $this->modx->getOption('stocks.core_path',$config,$this->modx->getOption('core_path').'components/stocks/');
        $assetsUrl = $this->modx->getOption('stocks.assets_url',$config,$this->modx->getOption('assets_url').'components/stocks/');
        ...
        $this->modx->addPackage('stocks',$this->config['modelPath']);
    }
    ...
    public function initialize($ctx = 'web') {
        switch ($ctx) {
            case 'mgr':
                $this->modx->lexicon->load('stocks:default');

                if (!$this->modx->loadClass('stocksControllerRequest',$this->config['modelPath'].'stocks/request/',true,true)) {
                    return 'Could not load controller request handler.';
                }
                $this->request = new stocksControllerRequest($this);
